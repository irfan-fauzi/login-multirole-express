...
RoleRoutes.get("/role", Authenticated_1.Authenticated, Authorization_1.BasicUser, RolesController_1.getAllRoles);
RoleRoutes.get("/role/:id", Authorization_1.BasicUser, RolesController_1.getRoleById);
