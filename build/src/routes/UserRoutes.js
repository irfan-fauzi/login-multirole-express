...
UserRoute.get("/user/current-user", Authenticated_1.Authenticated, UserController_1.UserDetail);
UserRoute.get("/user/logout", Authenticated_1.Authenticated, UserController_1.UserLogout);
